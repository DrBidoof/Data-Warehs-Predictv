...
export default function DataExploration() {
  ...
  async function run() {
    ...
    setIndex(0)
    try {
      const r = await fetch('http://localhost:5000/run/exploration')
  ...
  useEffect(() => {
    setIndex(0)
  }, [result && result.images && result.images.length])
  ...
  return (
    <div>
      ...
      <p>Runs `Data exploration.py` and returns stdout/stderr and figures.</p>
